...
//         <RouterLink
//           to="/login"
//           className="relative flex items-center gap-2 px-4 py-3 rounded-md text-[18px] font-bold text-[hsla(0,0%,90%)] bg-gradient-to-br from-olive to-brown hover:scale-110 transition"
//         >
//           Login
//         </RouterLink>
//         <RouterLink
//           to="/signup"
//           className="relative px-5 py-3 rounded-md border-2 border-white text-grey hover:text-white hover:scale-110 transition"
//         >
//           Signup
//         </RouterLink>
//       </div>
